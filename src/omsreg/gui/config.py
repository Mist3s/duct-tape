...
# Общая настройка программы: проверять ли обновление при запуске. Значения «1»/«0».
# Пространство «app» — то же соглашение «<кто>.<ключ>», что и у полей утилит
# (codes.min_len, stat.day_kotd), только вместо id утилиты — сама программа: ключ не
# выводится из схемы параметров, потому что не принадлежит ни одной вкладке.
KEY_CHECK_UPDATES = "app.check_updates"

HEADER_LINES = (
    "# Настройки программы «Синяя изолента».",
