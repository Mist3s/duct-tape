...
# Название и подзаголовок программы. «Синяя изолента» — про универсальность
# (набор инструментов на все случаи), поэтому область работы перечислена строкой ниже:
# программа давно не только про DBF-реестры ОМС, но и про отчёты Excel/HTML.
APP_TITLE = "Синяя изолента"
APP_SUBTITLE = ("инструменты медицинской статистики: реестры ОМС (DBF), "
                "стационар, смертность, отчёты Excel и HTML")
