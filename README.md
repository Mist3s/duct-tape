...
Слева — список утилит, справа — поля выбранной утилиты и общий журнал работы.

| Удаление по протоколам | Удаление по списку кодов | Статистика стационара |
|:---:|:---:|:---:|
| ![Удаление по протоколам](docs/screenshots/talons.png) | ![Удаление по списку кодов](docs/screenshots/codes.png) | ![Статистика стационара](docs/screenshots/stat.png) |
...
Больше ничего менять не нужно — вкладка, хранение настроек и поток запуска
